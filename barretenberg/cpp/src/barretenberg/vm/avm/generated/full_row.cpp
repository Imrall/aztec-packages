...
template <typename FF> std::vector<std::string> AvmFullRow<FF>::names()
{
    return { "byte_lookup_sel_bin",
             ...
             "gas_sel_gas_cost",
             "main_clk",
             "main_sel_da_end_gas_kernel_input",
             "main_sel_da_start_gas_kernel_input",
             "main_sel_first",
             "main_sel_l2_end_gas_kernel_input",
             "main_sel_l2_start_gas_kernel_input",
             "main_sel_start_exec",
             "main_zeroes",
             "powers_power_of_2",
             "main_kernel_inputs",
             ...
             "perm_rng_gas_l2_inv",
             "perm_rng_gas_da_inv",
             "perm_l2_start_gas_inv",
             "perm_da_start_gas_inv",
             "perm_l2_end_gas_inv",
             "perm_da_end_gas_inv",
